...
class bbRpc_auth extends apiModule
{
     ...
     * @throws exception
     */
    public function auth($username = RPF_API_MODULE_BBRPC_AUTH_USER, $password = RPF_API_MODULE_BBRPC_AUTH_PASSWORD, $fallback = 'httpAuth')
    {
        // Try to authenticate
        ...
        elseif ($fallback == 'httpAuth')
        {
            ...
            $result = $this->httpAuth();
            log::debug("Auth-Response: $result", __METHOD__);
            return $result;
        }
